...
public:
    ...
    {
        std::any left = evaluate(expr->left_expr);
        std::any right = evaluate(expr->right_expr);
        ...
        case EQUAL_EQUAL:
            return isEqual(left, right);
        case GREATER:
            checkNumberOperands(expr->operator_token, left, right);
    ...
    {
        return evaluate(expr->inner_expr);
    }
    ...
    {
        std::any right = evaluate(expr->operand);
        ...
        case MINUS:
            checkNumberOperand(expr->operator_token, right);
